...
public class ContestorController extends BaseController {
	...
	public @ResponseBody
	List<Contestor> getContestorsByContestGroupStaffRole(
	...
	List<Contestor> getContestorsByContestGroupStaffRole(
		...
		return getDatabaseService().selectContestorByContestGroup(
	...
	@ResponseStatus(value = HttpStatus.OK)
	public @ResponseBody
	List<Contestor> getAllContestors() throws Exception {
	...
	@ResponseStatus(value = HttpStatus.OK)
	public @ResponseBody
	BaseResponse deleteContestor(@PathVariable(value = "id") String id)
			throws Exception {
	...
	@ResponseStatus(value = HttpStatus.OK)
	public @ResponseBody
	BaseResponse insertContestor(@RequestBody Contestor record)
			throws Exception {
	...
	@ResponseStatus(value = HttpStatus.OK)
	public @ResponseBody
	BaseResponse updateStudent(@RequestBody Contestor record) throws Exception {
